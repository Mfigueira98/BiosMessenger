...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width:100%;">
        ...
        <tr>
            <td class="auto-style22">Remitentes:</td>
            <td class="auto-style17">
                <asp:DropDownList ID="ddlRemitentes" runat="server" AutoPostBack="True" Width="300px" BackColor="#DDEAF9">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style11" colspan="2">
                <asp:GridView ID="gvMensajes" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="#DDEAF9" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="2" Height="170px" PageSize="6" Width="877px" OnPageIndexChanging="gvMensajes_PageIndexChanging" OnSelectedIndexChanged="gvMensajes_SelectedIndexChanged" DataKeyNames="IdMensaje">
                    <Columns>
                        <asp:BoundField DataField="FechaHoraEnvio" HeaderText="Fecha" DataFormatString="{0:dd/MM/yyyy HH:mm}" />
                        <asp:BoundField DataField="Asunto" HeaderText="Asunto" />
                        <asp:BoundField DataField="NomUsuEnvia.NombreUsu" HeaderText="Remitente" />
  ...
  <tr>
    <th class="auto-style23">Texto</th>
    <td><asp:Label ID="lblTexto" runat="server" /></td>
  </tr>
  <tr>
